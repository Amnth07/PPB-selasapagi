...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: IphonePageState());
  }
}

class IphonePageState extends StatefulWidget {
  const IphonePageState({super.key});

  @override
  State<IphonePageState> createState() => _IphonePageState();
}

class _IphonePageState extends State<IphonePageState> {
  DateTime date = DateTime(2022, 11, 22);

  void _showDialog(Widget child) {
    showCupertinoModalPopup<void>(
      context: context,
      builder: (BuildContext contxt) => Container(
        height: 250,
